...
const rulesTextBoiler = "You have one minute (1m) to answer as many questions as possible. During the game on each question you need to select who is this Hogwart's student You see on the picture, on the left(someone right now) from availible options.";

const modeRules = () => {
    const rulesIcon = elementCreator(
        'span',
